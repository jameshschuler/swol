  ...
  <div class="view">
    <article>
      ...
      <p>
        ...
        to it, still belong to James Schuler.
      </p>
      <p>
        James Schuler is committed to ensuring that the app is as useful and efficient as possible.
      ...
      <p>
        The Swol app stores and processes personal data that you have provided to us, to provide my
        ...
        compromise your phone’s security features and it could mean that the Swol app won’t work
        properly or at all.
      </p>
      <div>
      ...
      <p>
        You should be aware that there are certain things that James Schuler will not take
        ...
        provider, but James Schuler cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, James Schuler cannot always take responsibility for the way you use
        the app i.e. You need to make sure that your device stays charged – if it runs out of
        battery and you can’t turn it on to avail the Service, James Schuler cannot accept
        responsibility.
      </p>
      <p>
        With respect to James Schuler’s responsibility for your use of the app, when you’re using
        the app, it’s important to bear in mind that although we endeavor to ensure that it is
        updated and correct at all times, we do rely on third parties to provide information to us
        so that we can make it available to you. James Schuler accepts no liability for any loss,
      ...
      <p>
        ...
        &amp; iOS – the requirements for the both systems(and for any additional systems we decide
        to extend the availability of the app to) may change, and you’ll need to download the
        updates if you want to keep using the app. James Schuler does not promise that it will
        ...
        updates to the application when offered to you, We may also wish to stop providing the app,
        and may terminate use of it at any time without giving notice of termination to you. Unless
        we tell you otherwise, upon any termination, (a) the rights and licenses granted to you in
      ...
      <p>These terms and conditions are effective as of 2022-07-19</p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions, do not hesitate to
        contact me at jameshschuler1@gmail.com.
      </p>
      <p>
